...
1. Sugeneruokite atsitiktinių dydžių vektorius (n=100)  x1, x2 ir ε iš populiacijos su tokiomis charakteristikomis:
 var(x1)=5,var(x2)=5,cor(x1,x2)=0.9,var(ε)=1var.
...
sigma
mat = mvrnorm(n =100, rep(0,2),sigma) # Sugeneruojame matricą iš x1 ir x2
var(mat)
...
Šaltiniai: Deivydas Sinkevičius, Raigardas Balužis